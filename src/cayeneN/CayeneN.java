...
public class CayeneN {
	
	private Double proporcao;
	private List<String> linhasBrutasTreino;
	private List<String> linhasBrutasTeste;
	private LinkedList<Linha> conjuntoEntradaTreino;
	private LinkedList<Linha> conjuntoEntradaTeste;
	private LinkedList<Linha> conjuntoTreino;
	private LinkedList<Classe> conjuntoClasses;
	private double matrizConfusao[][];
	
	public CayeneN(Double proporcao, List<String> linhasBrutasTreino) {
	...
	public CayeneN(List<String> linhasBrutasTreino) {
		this.setLinhasBrutasTreino(linhasBrutasTreino);
		conjuntoEntradaTreino = new LinkedList<>();
		converterLinhas(linhasBrutasTreino, conjuntoEntradaTreino);
	}

	public CayeneN(Double proporcao, List<String> linhasBrutasTreino, List<String> linhasBrutasTeste) {
		this.setProporcao(proporcao);
		this.setLinhasBrutasTreino(linhasBrutasTreino);
	...
	public void executaTeste(LinkedList<Linha> conjuntoEntrada, int k) {
	...
	public void crossValidation(int k) {
		...
		randomizaLinhas();
		setMatrizConfusao();
		executaTeste(conjuntoEntradaTreino, k);
	}
	...
	public void testar(int k) {
		...
		randomizaLinhas();
		setMatrizConfusao();
		executaTeste(conjuntoEntradaTeste, k);
	}
	...
	private Double calculaNorma(Double valor, Double maiorValor, Double menorValor) {
		...
		Double newMax = 1.0;
		Double newMin = 0.0;
		valorResultado = ((valor - menorValor)/(maiorValor - menorValor)) * (newMax - newMin) + newMin;
	...
	private LinkedList<TipoCaracteristica> extrairCaracteristicas(LinkedList<Linha> conjuntoEntrada, List<String> linhasBrutas) {
		...
		for (String linha : linhasBrutas) {
			...
			for (i = 0 ; i < vetorCaracteristicas.length-1 ; i++) {
				...
				conjuntoCaracteristicas.get(i).media();
				conjuntoCaracteristicas.get(i).variancia();
			}
